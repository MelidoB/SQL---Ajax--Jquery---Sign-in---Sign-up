...
<body>
    ...
    <form method="post">
        ...
        <h3><label for="username_sign_up">username</label></h3><input type="text"  name="username_sign_up">
        <h3><label for="password_sign_up">password</label></h3><input type="password"  name="password_sign_up">
...
<div id="sign_in_container">
        <form method="post" id="sign_in_form">
            ...
            <h3><label for="username_sign_in">username</label></h3><input type="text" name="username_sign_in">
            <h3><label for="password_sign_in">password</label></h3><input type="password"  name="password_sign_in">
